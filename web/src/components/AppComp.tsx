...
import { ActionIcon, Box, Button, Center, Flex, Group, Text } from '@mantine/core';
  ...
  return (
    <Box className={classes.app_container} py={10} h={360} w={330} bg={'#25262b'} mx="auto">
      <Group justify="end" px={8}>
        <ActionIcon color="yellow" size="lg" radius="md" variant="light" onClick={handleClose}>
          {closeIcon}
        </ActionIcon>
      </Group>
      <Center className={classes.center}>
        <Flex gap="md" justify="center" align="center" direction="column" wrap="wrap">
          <Button mt={50} variant="light" radius="xl" size="xl" onClick={handleGetPlayerMoney}>
            {locale.ui_buttonText}
          </Button>
          <Text ta="center" c="white" size="xl" px={6} bg={'#4a4a4a'} fw={700} fz="xl">
